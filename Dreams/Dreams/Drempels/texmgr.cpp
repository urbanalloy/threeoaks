...
bool texmgr::LoadTex256(char *szFilename, int iSlot, bool bResize, bool bAutoBlend, int iBlendPercent)
{
	...
	D3DXCreateTextureFromFileEx(g_pd3dDevice, szFilename, 256, 256, 1, 0, D3DFMT_A8R8G8B8, D3DPOOL_MANAGED, D3DX_FILTER_LINEAR, D3DX_FILTER_LINEAR, 0x00000000, NULL, NULL, &texture);
	if (texture)
	{
