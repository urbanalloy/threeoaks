...
{
public:
	WaterField(LPDIRECT3DDEVICE9 device);
	WaterField(LPDIRECT3DDEVICE9 device, float xmin, float xmax, float ymin, float ymax, int xdivs, int ydivs, float height, float elasticity, float viscosity, float tension, float blendability, bool textureMode);
	~WaterField();
	void Init(LPDIRECT3DDEVICE9 device, float xmin, float xmax, float ymin, float ymax, int xdivs, int ydivs, float height, float elasticity, float viscosity, float tension, float blendability, bool textureMode);
