...
Usage:
	 ...
	 files and add a member variable of tyle ODConsole.
...
bool ODConsole::Create(const char *szTitle, bool bNoClose)
{
#ifndef _DEBUG
	return false;
#endif
...
void ODConsole::Color(WORD wColor)
{
	CHECK(hConsole);
...
void ODConsole::Output(const char* szOutput, ...)
{
	CHECK(hConsole);
...
void ODConsole::SetTitle(const char *title)
{
	// self-explanatory
	SetConsoleTitle(title);
}

char* ODConsole::GetTitle()
{
...
void ODConsole::Show(bool bShow)
{
	CHECK(hConsole);
...
HANDLE ODConsole::GetHandle()
{
	// simply return the handle to our console
	return hConsole;
}

void ODConsole::Close()
{
